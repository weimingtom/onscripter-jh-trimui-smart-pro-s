...
#if defined(MIYOO)
    window = SDL_CreateWindow(NULL, window_x, window_y, 960 /*1280*/ /*640*/, 720/*480*/, window_flag);
#else
...
#if defined(MIYOO)
    SDL_RenderSetLogicalSize(renderer, 960 /*1280*/ /*640*/, 720/*480*/); //Auto scale center
#else
