...
INCS = -Os $(ARCH) -I./jpeg-6b_mod -I./libpng-1.2.24_mod -I${SYSROOT}/usr/include -I${SYSROOT}/usr/include/SDL2 -ffunction-sections -fdata-sections -Wall
LIBS = -L${SYSROOT}/usr/lib $(ARCH) -lSDL2_ttf -lSDL2_image -lSDL2_mixer -lSDL2 -lmad -lfreetype -lbz2 -lz -lpthread -lm
#-ljpeg -lpng
#removed -lSDL2_image
EXT_FLAGS =
else
DEFS = -DLINUX -DUSE_SDL_RENDERER -DNDEBUG -DMIYOO
INCS = `sdl2-config --cflags` -I./jpeg-6b_mod -I./libpng-1.2.24_mod 
LIBS = `sdl2-config --libs` -lSDL2_image -lSDL2_ttf -lSDL2_mixer   -lz -lbz2 -lm
#-ljpeg -lpng
EXT_FLAGS = 
 endif
...
# for GNU g++
ifeq ($(MIYOO),1)
GCC = /home/wmt/work_trimui/aarch64-linux-gnu-7.5.0-linaro/bin/aarch64-linux-gnu-gcc 
